...
- **Accessibility Expectations**: [Define Dynamic Type, VoiceOver, and non-color-only
  meaning requirements for user-facing interactions]
- **XcodeGen Impact**: [State whether `project.yml` changes are required and confirm
  generated Xcode project/product artifacts remain uncommitted]
- **Validation Path**: [Name the unit tests, UI tests, CI checks, or manual validation
  needed to prove the feature works]
