...
- **Family Value Fit**: Feature preserves or improves the practical family routine across
...
- **On-Device Privacy**: MVP data remains local. No backend, analytics, tracking, or network
  dependency is introduced unless the constitution is amended.
- **Accessibility and Calm Design**: User-facing UI includes Dynamic Type, VoiceOver labels,
  non-color-only meaning, and calm family-planning visuals.
- **Testable Increment**: Each behavior change names unit/UI test coverage or a justified
  verification path. GitHub Actions build/test confidence is preserved.
